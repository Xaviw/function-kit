// import type { CanvasElements, CanvasImageElement, CanvasLineElement, CanvasRectElement, CanvasRenderFn, CanvasTextElement } from '../../types/canvas'
...
// export function isTextElement(element: CanvasElements | CanvasRenderFn): element is CanvasTextElement {
//   return typeof element === 'object' && element.type === 'text'
// }

// export function isImageElement(element: CanvasElements | CanvasRenderFn): element is CanvasImageElement {
//   return typeof element === 'object' && element.type === 'image'
// }

// export function isRectElement(element: CanvasElements | CanvasRenderFn): element is CanvasRectElement {
//   return typeof element === 'object' && element.type === 'rect'
// }

// export function isLineElement(element: CanvasElements | CanvasRenderFn): element is CanvasLineElement {
